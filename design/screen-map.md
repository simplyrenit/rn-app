...
| Product detail | `ProductDetail` (`src/screens/products/products-screen.tsx`) | `1:9120` | frame in section `1:8957` | AUDITED | Concept differs (full-bleed hero vs contained photo on white); see `design/audit.md`. Waiting on a go-ahead because it replaces the scroll-collapsing hero. |
