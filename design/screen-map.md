...
| Welcome / onboarding | `Welcome` (`src/screens/welcome.tsx`) | — | — | DONE (no frame; light+dark, 2026-09-20) | Actions get their own 24pt gutter. Captures `design/app/onboarding.{light,dark}.iphone16e.png`. The light artwork has a baked off-white rectangle (asset re-export needed). |
