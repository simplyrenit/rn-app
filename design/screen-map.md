...
| Legal: terms, privacy | `Terms`, `Privacy` (`src/screens/terms.tsx`, `privacy.tsx`) | `1:11963`, `1:11981` | `1:11542`, `1:11560` | DONE (light+dark; Terms dark walked 2026-09-20, Privacy dark compared earlier) | Layout only; the frames' legal text is an older version than the app's and is not copied. See `design/audit.md`. |
| Static info: who we are, FAQ, contact us | `whoWeAre`, `faq`, `contactUs` | `1:11932`, `1:11770`, `1:11890` | `1:11511`, `1:11349`, `1:11469` | DONE (light+dark) | Reached from the signed-out Profile list; see the Profile sub-screens row and `design/audit.md`. |

## Phase B — signed in (needs Yash to sign in once)

| Screen | Route (file) | Status | Notes |
| --- | --- | --- | --- |
| Chat thread | `ChatDetails` | DONE (light compared to the frame on device; dark checked by eye, no committed dark capture, see `design/audit.md`) | Frames light `1:15543`, `1:15593`, `1:15651`, `1:15695`, `1:15742` (section `1:15542`; dark in section `1:15316`). Header, message list, text bubbles and composer restyled to `1:15651` from a measured spec and the 2× exports in `design/figma-images/chat/frames/`; type-checked only. Nothing was run: opening a thread on this signed-in session marks it read on the real backend, so device verification still waits for an `AGENT_QA_<run-id>` fixture conversation. Dark is by token only. The ⋯ menu (`1:15543`), the Block & Report sheet (`1:15593`), the offer/attachment bubbles and frames `1:15695`/`1:15742` are not audited. Two WCAG 1.4.11 deviations to rule on — see `design/audit.md`. |
