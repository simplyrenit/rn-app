...
description: Deliver a scoped Renit React Native feature or bug fix through the correct navigation, context, API, component, and native ownership layers. Use when Claude needs to implement, modify, or verify a targeted Renit app change before independent review and device QA.
---
...
1. Read `CLAUDE.md`, identify the user-visible flow, and trace it through navigation, state context, API hook, screen, and reusable component before editing.
